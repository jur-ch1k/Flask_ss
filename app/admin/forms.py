...
class VarsCreation(FlaskForm):
    ...
    p1 = StringField('p1', default=params['p1'], validators=[DataRequired()])
    p2 = StringField('p2', default=params['p2'], validators=[DataRequired()])
    p3 = StringField('p3', default=params['p3'], validators=[DataRequired()])
    p4 = StringField('p4', default=params['p4'], validators=[DataRequired()])
    p5 = StringField('p5', default=params['p5'], validators=[DataRequired()])
    p6 = StringField('p6', default=params['p6'], validators=[DataRequired()])
